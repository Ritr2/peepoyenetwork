            ...
            <div
              ...
              <AnimatePresence >
                <motion.div
                  ...
                  <img src={images[visibleRange[0]]} alt="Akassh ashok Gupta" className={`${visibleRange[0] === 3 ? 'w-14' : 'w-28'} h-auto`} draggable={false} />
                  <img src={images[visibleRange[1]]} alt="Akassh ashok Gupta" className={`${visibleRange[1] === 3 ? 'w-14' : 'w-28'} h-auto`} draggable={false} />
                </motion.div>
              </AnimatePresence>
            </div>
          </div>
