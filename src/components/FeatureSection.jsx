...
export default function FeatureSection({data, reverse, backgroundColor}) {
  return (
    <section className={`flex flex-col md:flex-row px-5 md:px-20 items-center justify-center py-6 md:py-12 gap-4 md:gap-14 ${backgroundColor}`}>
        <div className="flex flex-col flex-1 gap-2 md:gap-5 order-2">
