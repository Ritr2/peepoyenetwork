...
import Button from '@/components/funnels/pages/guide-x-free/GuideForm'
          ...
          >
            <div className={`flex flex-col w-full gap-5`}>
              <div className={`flex flex-col items-center w-full p-3 rounded-lg bg-neutral-100 border-2 border-neutral-200 border-dashed`}>
                ...
                <span className="text-base md:text-2xl font-normal md:font-bold text-center md:text-left text-blue-500">Today’s Offer: Free</span>
              </div>
              <Button successUrl= {`https://akassh.peepoye.com/foundational-accelerator-x-ind`} text='Get your X Guide Free<br/>only for today' padding='px-5 py-2' bgcolor={{ normal: 'bg-blue-500', hover: 'bg-blue-700', active: 'bg-blue-800' }} txcolor='text-white' />
            </div>
          </motion.div>
        </div>
