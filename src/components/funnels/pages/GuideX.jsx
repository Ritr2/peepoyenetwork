        ...
        <div className="flex flex-col flex-1 justify-center items-start gap-5 order-2 md:order-1">
          ...
          >
            <div className={`flex flex-col w-full gap-5`}>
              ...
              <Button successUrl= {`https://akassh.peepoye.com/foundational-accelerator-x-ind`} amount='guide-x' text='Buy X Guide only for today at an unbelievable 80% Discount' padding='px-5 py-2' bgcolor={{ normal: 'bg-blue-500', hover: 'bg-blue-700', active: 'bg-blue-800' }} txcolor='text-white' />
            </div>
          </motion.div>
        </div>
