...
export default function Experience() {
  ...
  return (
    <section className='md:px-20 w-full'>
      <div className='flex flex-col gap-3 py-3 z-10 w-full shadow-lg drop-shadow-lg border-2 rounded-3xl bg-green-600/10 border-stone-200'>
        <h2 className="text-sm md:text-2xl tracking-wide font-bold text-center text-neutral-800">A YOUTUBER WITH 20+ YRS OF EXP. CONSULTING TOP BRANDS</h2>
        <div className='flex flex-row items-center px-2'>
          ...
          <BsArrowRightCircleFill className='text-xl md:hidden cursor-pointer text-neutral-800' onClick={handlescrollright} />
        </div>
      </div>
    </section>
  )
