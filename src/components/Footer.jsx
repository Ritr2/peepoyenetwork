    ...
    <footer className={`${style.backgroundImage} flex flex-col items-center py-4 px-1 md:p-20`}>
      ...
      <div className="flex flex-col md:flex-row gap-2 md:gap-36 z-10">
        ...
        <div className="flex flex-col gap-5 justify-start">
          ...
          <div className="flex flex-row gap-5 items-center justify-between">
            <a href='https://www.youtube.com/@peepoye' target="_blank" rel="noopener noreferrer"><img src="https://i.ibb.co/Vgpc3FW/youtube.png" className="w-14 md:w-16 h-auto" /></a>
            <a href='https://www.instagram.com/peepoye/' target="_blank" rel="noopener noreferrer"><img src="https://i.ibb.co/r2HjkRR/instagram.png" className="w-14 md:w-16 h-auto" /></a>
            <a href='https://www.facebook.com/peepoye' target="_blank" rel="noopener noreferrer"><img src="https://i.ibb.co/s90Nqhz/facebook.png" className="w-14 md:w-16 h-auto" /></a>
            <a href='https://twitter.com/peepoye_' target="_blank" rel="noopener noreferrer"><img src="https://i.ibb.co/7Kq3Rg9/twitter.png" className="w-14 md:w-16 h-auto" /></a>
          </div>
        </div>
      </div>
      <div className='flex flex-row gap-2 mt-10 w-full items-center z-10'>
        <div className="flex flex-col gap-2 w-2 border-b-2 flex-1" />
        <img src="https://i.ibb.co/6vX34KQ/akassh-signature.png" className="w-40 md:w-52 h-auto" />
        <div className="flex flex-col gap-2 w-2 border-b-2 flex-1" />
      </div>
      <div className="flex md:flex-row flex-col gap-3 mt-10 w-full items-center justify-between z-10">
        ...
        <div className="flex flex-row flex-1 justify-center">
          ...
          <Link href="/help" className="text-base font-sans font-thin md:text-xl text-left px-2 cursor-pointer border-white text-white">Help Center</Link>
        </div>
