      ...
      <section className="flex flex-col md:flex-row items-center justify-center md:gap-10 py-20">
        ...
        <div className="flex flex-col justify-center gap-2 md:gap-5 pb-8 w-full md:w-6/12">
          ...
          <div className="flex flex-col w-full md:w-8/12">
            <Link href='/blogs' className={`flex flex-col items-center text-white font-bold w-full p-3 rounded-lg ${data?.specialBgColor ?? 'bg-gray-700'} hover:scale-105 active:scale-95 transform transition-all duration-200 ease-in-out`}>
