        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 w-full">
          ...
          <div className="flex flex-col items-end justify-center flex-1">
            <div className="flex flex-col w-full md:w-7/12">
              <img src='https://peepoyenetwork.com/wp-content/uploads/2024/01/gamification-leaderboard.jpg' alt="Akassh ashok Gupta" className="w-full rounded-lg shadow-lg drop-shadow-lg" draggable={false} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 w-full">
          ...
          <div className="flex flex-col items-end justify-center flex-1">
            <div className="flex flex-col w-full md:w-10/12">
              <img src='https://peepoyenetwork.com/wp-content/uploads/2024/01/image_mentoring.webp' alt="Akassh ashok Gupta" className="w-full rounded-lg shadow-lg drop-shadow-lg" draggable={false} />
            </div>
          </div>
        </div>
      </section>
