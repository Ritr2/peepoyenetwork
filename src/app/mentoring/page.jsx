...
export default function Mentoring() {
  return (
    <main className={`relative flex min-h-screen flex-col items-center mt-16 ${dmSans.className} overflow-x-hidden`}>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center md:gap-10 pt-5 px-5 md:px-52">
        <div className="flex flex-col justify-center flex-1 gap-2 md:gap-5 order-3 md:order-1">
          ...
          <div className="flex flex-col w-full md:w-9/12">
            <button className="text-lg md:text-xl text-center bg-neutral-600 text-white p-2 md:p-4 px-8 rounded-lg drop-shadow-lg shadow-lg hover:bg-neutral-700 hover:shadow-xl hover:drop-shadow-xl active:bg-neutral-800 active:shadow-2xl active:drop-shadow-2xl active:translate-x-1 active:scale-95">Join Now</button>
          </div>
        </div>
      ...
      <section className="flex flex-col items-center w-full justify-center gap-8 bg-white px-5 py-16 md:px-52 overflow-hidden">
        <h2 className="text-2xl md:text-4xl font-bold text-center text-neutral-700">Register For Akassh&apos;s Free Weekly Mentoring Programme</h2>
        <div className="flex flex-col justify-center gap-2 w-10/12">
          <p className='text-lg font-bold text-neutral-700'>1. New Content Updates &#40; Blogs, Videos, Podcasts &#41;</p>
          <p className='text-lg font-bold text-neutral-700'>2. Story/lessons from Akassh’s life</p>
          <p className='text-lg font-bold text-neutral-700'>3. Concepts and Ideas to build strong influence & create authority in the market of your choice</p>
          <p className='text-lg font-bold text-neutral-700'>P.N: Akassh Ashok Gupta writes all the emails himself — We value quality &gt; quantity.</p>
        </div>
