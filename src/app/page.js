    ...
    <main className={`relative flex min-h-screen flex-col items-center mt-20 ${dmSans.className}`}>
      <section className="flex flex-col md:flex-row items-center justify-center px-5 md:px-20">
        <div className="flex flex-col justify-center flex-1 gap-1 md:gap-2">
          <h1 className="text-4xl md:text-6xl font-bold text-center md:text-left text-neutral-700 mb-3">I Breathe Passion</h1>
          <p className="text-lg md:text-2xl text-center md:text-left text-neutral-700">Enabling Awareness & Happiness Via</p>
          <p className="text-lg md:text-2xl text-center md:text-left text-neutral-700">Content, Courses & Masterminds</p>
        ...
        <div className="flex flex-col items-center justify-center flex-1">
          <Image src={image} alt="Akassh ashok Gupta" width={1000} height={1000} className="w-full" />
        </div>
      </section>
      <Experience />
      {
