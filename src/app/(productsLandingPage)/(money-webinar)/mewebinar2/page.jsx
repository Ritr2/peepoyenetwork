        ...
        <div className='flex flex-col items-center justify-center bg-black/70 gap-5 md:gap-10 w-full flex-1 px-5 py-10 md:px-24'>
          <div className='flex flex-col items-center justify-center w-full gap-2 md:gap-4 flex-1'>
            ...
            <div className='flex flex-col items-center justify-center w-full md:w-6/12'>
              <Button amount='accelerator-2' text='Buy Now at ₹4999/- only' bgcolor={{ normal: 'bg-red-600', hover: 'bg-red-700', active: 'bg-red-800' }} txcolor='text-white' padding='py-3 md:py-4 px-5 md:px-10' successUrl='https://peepoye.com/thankyou?product=accelerator' />
            </div>
          </div>
          <div className='flex flex-col md:flex-row justify-center gap-5 md:gap-10 w-full'>
            ...
            <div className="relative flex flex-col items-center justify-center flex-1 p-1 md:p-3 gap-1 md:gap-2 rounded-lg bg-neutral-100 border-[4px] border-red-600 border-dashed">
              <span className='text-xl md:text-2xl font-bold text-center'>Date <span className='red-text'>|</span> Tuesday <span className='red-text'>|</span> 08:00PM to 09:30PM IST</span>
